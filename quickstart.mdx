...
<CardGroup cols={2}>
  <Card title="Explore LLMs" icon="message" href="/llm/overview">
    Learn about all supported language models and their features
  </Card>
  <Card title="Vision-language models" icon="eye" href="/vlm/overview">
  ...
  <Card title="Advanced usage" icon="graduation-cap" href="/advanced/quantization">
