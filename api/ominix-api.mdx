...
| `llm` | Enable LLM chat endpoints | Coming soon |
| `vlm` | Enable vision-language endpoints | Coming soon |
| `tts` | Enable text-to-speech endpoints | Coming soon |
...
<CardGroup cols={2}>
  ...
  <Card title="Speech recognition" icon="microphone" href="/models/speech-recognition">
